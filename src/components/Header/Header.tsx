...
const Header = () => {
  return (
    <div className='px-70 font-roboto'>
        <div className='flex justify-between items-center'>
            ...
            <div className='w-60 flex justify-between items-center gap-2'>
                <DefaultButton text="Login" customClasses='w-30 h-13 text-lg text-white border-o rounded-[35px] hover:w-31 hover:h-14 transition-all duration-100'/>
                <DefaultButton text="Sign Up" customClasses='w-30 h-13 text-lg text-white border-o rounded-[35px] hover:w-31 hover:h-14 transition-all duration-100' />
            </div>
        </div>
    </div>
  )
