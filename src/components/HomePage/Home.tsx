...
const Home = () => {
    ...
    return (
        <div id="home" className='px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 flex flex-col items-center justify-center min-h-[calc(109svh-17rem)] sm:min-h-0 pt-8 pb-6 sm:py-0 gap-6 sm:gap-7 text-center scroll-mt-28'>
