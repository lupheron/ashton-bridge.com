    ...
    return (
        <div id="home" className='px-70 flex flex-col items-center justify-center gap-7 text-center scroll-mt-28'>
            ...
            <div className='flex items-center justify-center gap-5'>
                ...
                <Link href="/services" className='inline-flex items-center justify-center w-40 h-12 rounded-[35px] bg-transparent text-text border border-text text-base font-medium hover:bg-text/10 transition-all duration-300'>
                    Explore Services
                </Link>
            </div>
