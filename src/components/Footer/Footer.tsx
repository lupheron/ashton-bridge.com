...
const Footer = () => {
    return (
        <div className='mt-8 sm:mt-12 md:mt-16 lg:mt-24 px-4 sm:px-8 md:px-10 lg:px-38'>
            <div className='flex flex-col items-center text-left sm:items-center sm:text-center lg:flex-row lg:items-start lg:justify-between lg:text-left gap-8 text-white'>
                <Image src="/ashton-logo-wth-bg.png" alt="Logo" width={100} height={100} className='w-24 sm:w-28 md:w-32 lg:w-50' />

                <div className='grid grid-cols-1 sm:grid-cols-2 gap-8 px-4 sm:px-8 md:px-10 lg:px-12 sm:gap-16 w-full max-w-3xl sm:place-items-center lg:w-auto lg:max-w-none lg:place-items-start'>
                    <div className='flex flex-col items-center text-start sm:items-center sm:text-center lg:items-start lg:text-left gap-2 text-base sm:text-lg md:text-xl'>
                    ...
                    <div className='flex flex-col items-center text-left sm:items-center sm:text-center lg:items-start lg:text-left justify-center gap-2 text-base sm:text-lg md:text-xl'>
