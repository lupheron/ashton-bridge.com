...
const Footer = () => {
    return (
        <div className='mt-8 sm:mt-12 md:mt-16 lg:mt-24 px-4 sm:px-8 md:px-10 lg:px-12'>
            <div className='flex flex-col items-start text-left sm:items-center sm:text-center gap-8 text-white'>
                ...
                <div className='flex flex-col items-start text-left sm:items-center sm:text-center gap-2 text-base sm:text-lg md:text-xl'>
                ...
                <div className='flex flex-col items-start text-left sm:items-center sm:text-center justify-center gap-2 text-base sm:text-lg md:text-xl'>
