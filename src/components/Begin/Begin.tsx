...
const Begin = () => {
    return (
        <div className='flex flex-col items-center justify-center text-center gap-4 sm:gap-5 mt-10 sm:mt-16 md:mt-24 lg:mt-30 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 text-white'>
            ...
            <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-[58px] xl:text-[60px] font-bold leading-tight'>Start building your business with Ashton-Bridge today</h1>
